...
```{r include=FALSE}
africa_vac <- readRDS("vacations/africa_vac.rds")
africa_vac_crime <- readRDS("vacations/africa_vac_crime.rds")
africa_vac_poll <- readRDS("vacations/africa_vac_poll.rds")
vacation_data <- readRDS("vacations/vacation_data.rds")
...
as_tibble(countries)
write.table(countries, "vacations/countries.txt", sep="\t")
```
...
```{r}
vacation_pref <- read.csv("vacations/vacation_pref.csv", sep=",")
